function init() {
  ...
  //To get session ID and new user event
  ...
  //To reset participants and display connected clients
  socket.on('newConnection', function (data) {
    updateParticipants(data.participants);
  });

  //When user disconnected remove the span element from the participants element
  socket.on('userDisconnected', function(data) {
    $('#' + data.id).remove();
  });

  //When name changed it update the span ith given ID
 ...
 //Enter button function
  ...
  //Function for send button to enable/dissable
